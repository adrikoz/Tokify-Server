...
const ERC20SourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/token/ERC20/ERC20.sol"
);
const IERC20SourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/token/ERC20/IERC20.sol"
);
const IERC20MetadataSourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/token/ERC20/extensions/IERC20Metadata.sol"
);
const ContextSourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/utils/Context.sol"
);
const AccessControlSourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/access/AccessControl.sol"
);
const IAccessControlSourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/access/IAccessControl.sol"
);
const StringsSourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/utils/Strings.sol"
);
const ERC165SourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/utils/introspection/ERC165.sol"
);
const IERC165SourceCode = fs.readFileSync(
  "./node_modules/@openzeppelin/contracts/utils/introspection/IERC165.sol"
);

module.exports.handler = async (event) => {
  console.log("erc20: ", `${ERC20SourceCode}`);
  ...
  try {
    ...
    var input = {
      ...
      settings: {
        // This is the one that i had missed
        outputSelection: {
          "*": {
            "*": ["*"],
          },
    ...
    if (type === "Rebase") {
      await new Promise((resolve, reject) => {
        solc.loadRemoteVersion(
          ...
          async function (err, solcSnapshot) {
            if (err) {
  ...
  async function processCompilerOutput(string_output) {
    ...
    console.log(
      "bytecode: ",
      output.contracts["contract.sol"][contractSelector].evm.bytecode.object
    );
    console.log(
      "abi: ",
      output.contracts["contract.sol"][contractSelector].abi
    );
    try {
      const upload_params = {
        ...
        Body: JSON.stringify({
          ...
          chain: chain,
          bytecode:
            output.contracts["contract.sol"][contractSelector].evm.bytecode
              .object,
